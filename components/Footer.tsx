  ...
  return (
    <div className="bg-ternary text-white font-fira-code px-[6px] sm:px-[18px] md:px-[64px] lg:px-[128px] 2xl:px-[168px] mt-36 md:mt-44 lg:mt-64 border-t border-secondary">
      <div className="flex justify-between align-middle items-center pt-16">
        <div className="flex justify-center items-start align-middle gap-4 flex-wrap w-[200px] text-justify sm:w-[250px] lg:w-[400px]">
          <svg
            width="52"
            height="52"
            viewBox="0 0 52 52"
          ...
          <p className="">Web designer and front-end developer</p>
        </div>
        <div>
          <h2 className="text-xl font-semibold pb-2">Media</h2>
          <div className="flex justify-center align-middle items-center space-x-2">
            ...
            <svg
              ...
              viewBox="0 0 32 32"
              fill="#ABB2BF"
              className="w-10 h-auto cursor-pointer hover:fill-white"
              xmlns="http://www.w3.org/2000/svg"
            >
